...
from sincehence_core.mixins import (
...
class Category(
    ...
    def get_absolute_url(self):
        return reverse('sincehence_core:category_detail', args=[str(self.slug)])
...
class Page(   
    ...
    top_banenr = models.ImageField(_('Top Banner'), upload_to='blog/top_banenr/')
    ...
    def get_absolute_url(self):
        return reverse('sincehence_core:page_detail', args=[str(self.slug)])
...
class Blog(
    ...
    def get_absolute_url(self):
        return reverse('sincehence_core:blog_details', args=[str(self.slug)])       

    def like_or_dislike_url(self):
        return reverse('sincehence_core:like_or_dislike', args=[int(self.get_content_type.id), str(self.id)])        
